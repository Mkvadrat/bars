<?php
// HTTP
define('HTTP_SERVER', 'http://sevbars.com/admin/');
define('HTTP_CATALOG', 'http://sevbars.com/');

// HTTPS
define('HTTPS_SERVER', 'http://sevbars.com/admin/');
define('HTTPS_CATALOG', 'http://sevbars.com/');
